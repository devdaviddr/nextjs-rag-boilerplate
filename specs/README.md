...
| [0025](0025-rag-knowledge-base-and-chat.md)       | PDF knowledge base & document chat                | Shipped  | v0.20.0         |
| [0026](0026-chat-first-ux-and-history.md)         | Rag Boilerplate: chat-first UX, history & sources | Shipped  | v0.20.0         |
| [0027](0027-agentic-rag-and-document-cracking.md) | Agentic RAG, document cracking & evaluation       | Shipped  | v0.20.0         |
...
>
> Remaining specs are listed above in priority order, each scoped to ship as
> its own release. Numbering has gaps (0008,
