...
| 1f Reranking                               | **Done, off by default** — [0036](0036-reranking.md): a local cross-encoder (no account) and an LLM backend; local measured hit@1 0.882 → 0.941, refusal 1.000, +1.5s         |
| 1g HyDE                                    | Not started                                                                                                                                                                   |
